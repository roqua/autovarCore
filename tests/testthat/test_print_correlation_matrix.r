context('print_correlation_matrix')
...
test_that('print_correlation_matrix returns the correct result', {
  ...
  expect_lt(abs(result[1, 1] - expected_result[1, 1]), 0.0000001)
  expect_lt(abs(result[3, 2] - expected_result[2, 2]), 0.0000001)
  expect_lt(abs(result[5, 3] - expected_result[3, 3]), 0.0000001)
  expect_lt(abs(result[3, 1] - expected_result[2, 1]), 0.0000001)
  expect_lt(abs(result[3, 1] - expected_result[1, 2]), 0.0000001)
  expect_lt(abs(result[5, 1] - expected_result[3, 1]), 0.0000001)
  expect_lt(abs(result[5, 1] - expected_result[1, 3]), 0.0000001)
  expect_lt(abs(result[5, 2] - expected_result[3, 2]), 0.0000001)
  expect_lt(abs(result[5, 2] - expected_result[2, 3]), 0.0000001)
  expect_lt(abs(result[4, 1] - 0.20724002), 0.0000001)
})
